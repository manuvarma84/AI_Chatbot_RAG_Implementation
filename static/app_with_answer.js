    ...
    async sendMessage() {
        ...
        try {
            ...
            if (data.error) {
                ...
                // Highlight keywords in the response content
                const highlightedAnswer = this.highlightKeywords(userInput, data.answer);
                this.addMessage("AI", highlightedAnswer);
                ...
                this.messages.push(data.answer); // Update history
                this.index = this.messages.length - 1;
            } else {
                this.addMessage("System", "No response received from the server.");
            }
        } catch (error) {
